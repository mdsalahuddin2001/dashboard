const Pagination = ({
  ...
  if (totalPage <= 5) {
    middlePagination = [...Array(totalPage)].map((_, index) => (
      <button
        className="bg-primary/10 text-primary text-xs h-8 w-8 rounded-full disabled:bg-primary disabled:text-white"
    ...
    middlePagination = (
      <>
        {[...Array(5)].map((_, index) => (
          <button
            className="bg-blue-100 text-primary text-xs h-8 w-8 rounded-full disabled:bg-primary disabled:text-white"
  ...
  return (
    <div className="my-4 flex justify-end">
      <div className="flex items-center space-x-2">
        ...
        <button
          className="text-xs px-4 py-2 rounded-full bg-primary text-white disabled:opacity-50 disabled:cursor-not-allowed"
