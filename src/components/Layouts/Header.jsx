      ...
      <div className="shadow-sm">
        <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
          <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
            <Link to="/" className="main-logo flex items-center -mt-4">
              <img
                width={118}
                height={47}
            ...
            >
              <HiBars3CenterLeft className="text-white rounded-full  h-6 w-6 bg-primary p-1" />
            </button> */}
          </div>
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M25.334 12.0007H6.66732C5.93094 12.0007 5.33398 11.4037 5.33398 10.6673C5.33398 9.93094 5.93094 9.33398 6.66732 9.33398H25.334C26.0704 9.33398 26.6673 9.93094 26.6673 10.6673C26.6673 11.4037 26.0704 12.0007 25.334 12.0007ZM25.334 22.6667H6.66732C5.93094 22.6667 5.33398 22.0697 5.33398 21.3333C5.33398 20.597 5.93094 20 6.66732 20H25.334C26.0704 20 26.6673 20.597 26.6673 21.3333C26.6673 22.0697 26.0704 22.6667 25.334 22.6667Z"
                      fill="#92929D"
                    />
                  </svg>
                </button>
